...
* [x] без токена защищённые маршруты дают 401
* [x] с USER токеном можно бронировать
* [x] USER не может админские методы (403)
* [x] ADMIN может админские методы
* [x] booking-service получает `X-User-Id`
