...
import my.project.bookingservice.pricing.calendar.PricingCalendarDayService;
import my.project.bookingservice.pricing.calendar.PricingCalendarDayValue;
...
public class DefaultCalendarClassifier implements CalendarClassifier {
	...
	private final PricingCalendarDayService calendarDayService;
	...
	public CalendarMembership classify(LocalDate date) {
		...
		PricingCalendarDayValue calendarDay = calendarDayService.getDay(date);
		boolean dayOff = calendarDay.dayOff();
		boolean holiday = calendarDay.holiday();
